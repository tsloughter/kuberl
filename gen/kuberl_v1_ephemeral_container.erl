-module(kuberl_v1_ephemeral_container).

-export([encode/1]).

-export_type([kuberl_v1_ephemeral_container/0]).

-type kuberl_v1_ephemeral_container() ::
    #{ 'args' => list(),
       'command' => list(),
       'env' => list(),
       'envFrom' => list(),
       ...
       'startupProbe' => kuberl_v1_probe:kuberl_v1_probe(),
       'stdin' => boolean(),
       'stdinOnce' => boolean(),
