-module(kuberl_batch_v1beta1_api).
...
%% @doc 
%% create a CronJob
-spec create_namespaced_cron_job(ctx:ctx(), binary(), kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
create_namespaced_cron_job(Ctx, Namespace, Body) ->
    create_namespaced_cron_job(Ctx, Namespace, Body, #{}).

-spec create_namespaced_cron_job(ctx:ctx(), binary(), kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec list_cron_job_for_all_namespaces(ctx:ctx()) -> {ok, kuberl_v1beta1_cron_job_list:kuberl_v1beta1_cron_job_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
list_cron_job_for_all_namespaces(Ctx) ->
    list_cron_job_for_all_namespaces(Ctx, #{}).

-spec list_cron_job_for_all_namespaces(ctx:ctx(), maps:map()) -> {ok, kuberl_v1beta1_cron_job_list:kuberl_v1beta1_cron_job_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
%% @doc 
%% list or watch objects of kind CronJob
-spec list_namespaced_cron_job(ctx:ctx(), binary()) -> {ok, kuberl_v1beta1_cron_job_list:kuberl_v1beta1_cron_job_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
list_namespaced_cron_job(Ctx, Namespace) ->
    list_namespaced_cron_job(Ctx, Namespace, #{}).

-spec list_namespaced_cron_job(ctx:ctx(), binary(), maps:map()) -> {ok, kuberl_v1beta1_cron_job_list:kuberl_v1beta1_cron_job_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec patch_namespaced_cron_job(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
patch_namespaced_cron_job(Ctx, Name, Namespace, Body) ->
    patch_namespaced_cron_job(Ctx, Name, Namespace, Body, #{}).

-spec patch_namespaced_cron_job(ctx:ctx(), binary(), binary(), maps:map(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec patch_namespaced_cron_job_status(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
patch_namespaced_cron_job_status(Ctx, Name, Namespace, Body) ->
    patch_namespaced_cron_job_status(Ctx, Name, Namespace, Body, #{}).

-spec patch_namespaced_cron_job_status(ctx:ctx(), binary(), binary(), maps:map(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec read_namespaced_cron_job(ctx:ctx(), binary(), binary()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
read_namespaced_cron_job(Ctx, Name, Namespace) ->
    read_namespaced_cron_job(Ctx, Name, Namespace, #{}).

-spec read_namespaced_cron_job(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec read_namespaced_cron_job_status(ctx:ctx(), binary(), binary()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
read_namespaced_cron_job_status(Ctx, Name, Namespace) ->
    read_namespaced_cron_job_status(Ctx, Name, Namespace, #{}).

-spec read_namespaced_cron_job_status(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec replace_namespaced_cron_job(ctx:ctx(), binary(), binary(), kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
replace_namespaced_cron_job(Ctx, Name, Namespace, Body) ->
    replace_namespaced_cron_job(Ctx, Name, Namespace, Body, #{}).

-spec replace_namespaced_cron_job(ctx:ctx(), binary(), binary(), kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec replace_namespaced_cron_job_status(ctx:ctx(), binary(), binary(), kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
replace_namespaced_cron_job_status(Ctx, Name, Namespace, Body) ->
    replace_namespaced_cron_job_status(Ctx, Name, Namespace, Body, #{}).

-spec replace_namespaced_cron_job_status(ctx:ctx(), binary(), binary(), kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), maps:map()) -> {ok, kuberl_v1beta1_cron_job:kuberl_v1beta1_cron_job(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
