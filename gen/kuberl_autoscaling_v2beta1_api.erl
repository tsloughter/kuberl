-module(kuberl_autoscaling_v2beta1_api).
...
-spec list_horizontal_pod_autoscaler_for_all_namespaces(ctx:ctx()) -> {ok, kuberl_v2beta1_horizontal_pod_autoscaler_list:kuberl_v2beta1_horizontal_pod_autoscaler_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
%% @doc 
%% list or watch objects of kind HorizontalPodAutoscaler
-spec list_namespaced_horizontal_pod_autoscaler(ctx:ctx(), binary()) -> {ok, kuberl_v2beta1_horizontal_pod_autoscaler_list:kuberl_v2beta1_horizontal_pod_autoscaler_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec patch_namespaced_horizontal_pod_autoscaler(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, kuberl_v2beta1_horizontal_pod_autoscaler:kuberl_v2beta1_horizontal_pod_autoscaler(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec patch_namespaced_horizontal_pod_autoscaler_status(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, kuberl_v2beta1_horizontal_pod_autoscaler:kuberl_v2beta1_horizontal_pod_autoscaler(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec read_namespaced_horizontal_pod_autoscaler(ctx:ctx(), binary(), binary()) -> {ok, kuberl_v2beta1_horizontal_pod_autoscaler:kuberl_v2beta1_horizontal_pod_autoscaler(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec read_namespaced_horizontal_pod_autoscaler_status(ctx:ctx(), binary(), binary()) -> {ok, kuberl_v2beta1_horizontal_pod_autoscaler:kuberl_v2beta1_horizontal_pod_autoscaler(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
