-module(kuberl_storage_v1beta1_api).
...
-spec create_storage_class(ctx:ctx(), kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
create_storage_class(Ctx, Body) ->
    create_storage_class(Ctx, Body, #{}).

-spec create_storage_class(ctx:ctx(), kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), maps:map()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec list_storage_class(ctx:ctx()) -> {ok, kuberl_v1beta1_storage_class_list:kuberl_v1beta1_storage_class_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
list_storage_class(Ctx) ->
    list_storage_class(Ctx, #{}).

-spec list_storage_class(ctx:ctx(), maps:map()) -> {ok, kuberl_v1beta1_storage_class_list:kuberl_v1beta1_storage_class_list(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec patch_storage_class(ctx:ctx(), binary(), maps:map()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
patch_storage_class(Ctx, Name, Body) ->
    patch_storage_class(Ctx, Name, Body, #{}).

-spec patch_storage_class(ctx:ctx(), binary(), maps:map(), maps:map()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec read_storage_class(ctx:ctx(), binary()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
read_storage_class(Ctx, Name) ->
    read_storage_class(Ctx, Name, #{}).

-spec read_storage_class(ctx:ctx(), binary(), maps:map()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
...
-spec replace_storage_class(ctx:ctx(), binary(), kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
replace_storage_class(Ctx, Name, Body) ->
    replace_storage_class(Ctx, Name, Body, #{}).

-spec replace_storage_class(ctx:ctx(), binary(), kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), maps:map()) -> {ok, kuberl_v1beta1_storage_class:kuberl_v1beta1_storage_class(), kuberl_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), kuberl_utils:response_info()}.
