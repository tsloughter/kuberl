-module(kuberl_extensions_v1beta1_deployment_spec).

-export([encode/1]).

-export_type([kuberl_extensions_v1beta1_deployment_spec/0]).

-type kuberl_extensions_v1beta1_deployment_spec() ::
    #{ 'minReadySeconds' => integer(),
       ...
       'strategy' => kuberl_extensions_v1beta1_deployment_strategy:kuberl_extensions_v1beta1_deployment_strategy(),
