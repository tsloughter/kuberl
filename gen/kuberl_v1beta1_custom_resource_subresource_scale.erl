-module(kuberl_v1beta1_custom_resource_subresource_scale).

-export([encode/1]).

-export_type([kuberl_v1beta1_custom_resource_subresource_scale/0]).

-type kuberl_v1beta1_custom_resource_subresource_scale() ::
